        ...
        <form role="form" action="<?= base_url()."index.php/".$action ?>" method="post" class="innline">
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="animal" name="animal" placeholder="Ingrese Animal"
                ...
                <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="reproductor" name="reproductor" placeholder="Ingrese el Reproductor"
                ...
                <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="tipo_servicio" name="tipo_servicio" placeholder="Ingrese Servicio"
