        ...
        <form role="form" action="<?= base_url()."index.php/".$action ?>" method="post" class="innline">
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="causa_no_enseminal" name="causa_no_enseminal" placeholder="Ingrese causa no inseminal"
                     value=<?php if(isset ($celo)) echo $datos->celo_causa_no_inseminal;?> >
                </div>
                <div class="form-group">
                    <label for="nombre">Medicina Genital</label>
                    <input type="text" class="form-control" id="medicina_genital" name="medicina_genital" placeholder="Ingrese medicina genital"
                     value=<?php if(isset ($celo)) echo $datos->celo_medicina_genital;?> >
                </div>
                <div class="form-group">
                    <label for="nombre">Via Aplicacion</label>
                    <input type="text" class="form-control" id="via_aplicacion" name="via_aplicacion" placeholder="Ingrese medicina genital"
