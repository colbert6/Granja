        ...
        <form role="form" action="<?= base_url()."index.php/".$action ?>" method="post" class="innline">
            <div class="box-body">
                ...
                <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="diag_utero" name="diag_utero" placeholder="Ingrese el Diagnostico de Utero"
                                value=<?php if(isset ($tacto_rectal)) echo $datos->tarec_diag_utero;?>>
                </div>
                <div class="form-group">
                                <label for="fechareg">Enfermedad de Ovario</label>
                                <input type="text" class="form-control" id="enfe_ovario" name="enfe_ovario" placeholder="Ingrese Enfermedad de Ovario"
                                value=<?php if(isset ($tacto_rectal)) echo $datos->tarec_enfe_ovario;?>>
                </div>
                <div class="form-group">
                                <label for="fechareg">Enfermedad de Utero</label>
                                <input type="text" class="form-control" id="enfe_utero" name="enfe_utero" placeholder="Ingrese Enfermedad de Utero"
                                value=<?php if(isset ($tacto_rectal)) echo $datos->tarec_enfe_utero;?>>
                </div>
                <div class="form-group">
                                <label for="fechareg">Via Aplicacion</label>
                                <input type="text" class="form-control" id="via_aplicacion" name="via_aplicacion" placeholder="Ingrese Enfermedad de Utero"
                                value=<?php if(isset ($tacto_rectal)) echo $datos->tarec_via_aplicacion;?>>
                </div>
                <div class="form-group">
                                <label for="fechareg">Medicina Genital</label>
                                <input type="text" class="form-control" id="med_genital" name="med_genital" placeholder="Ingrese Medicina Genital"
