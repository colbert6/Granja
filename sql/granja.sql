...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-05-2016 a las 21:52:47
...
(1, 1, 1, '2016-01-01 00:00:00', 1),
(2, 1, 1, '2016-01-01 00:00:00', 1),
(3, 1, 2, '2015-01-02 00:00:00', 1),
(4, 1, 1, '2014-01-03 00:00:00', 1);
...
INSERT INTO `analisis` (`ana_id`, `ana_tipo_analisis`, `ana_animal`, `ana_fecha_evento`, `ana_resul_analisis`, `ana_estado`) VALUES
(1, 1, 1, '2016-01-01 00:00:00', 1, 1),
(2, 1, 1, '2015-04-11 00:00:00', 1, 1);
...
(141, 'inciar sesion', 'login', '2016-05-14 09:32:08', 1, '', 'Colbert', 1),
(142, 'insertar', 'aborto', '2016-05-14 09:34:32', 1, '', 'Colbert', 0),
(143, 'insertar', 'analisis', '2016-05-14 10:15:57', 1, '', 'Colbert', 0),
(144, 'insertar', 'aborto', '2016-05-14 10:52:47', 1, '', 'Colbert', 0),
(145, 'insertar', 'aborto', '2016-05-14 11:27:55', 1, '', 'Colbert', 0),
(146, 'modificar', 'aborto', '2016-05-14 11:28:36', 1, '', 'Colbert', 3),
(147, 'modificar', 'aborto', '2016-05-14 11:28:45', 1, '', 'Colbert', 3),
(148, 'insertar', 'aborto', '2016-05-14 11:33:05', 1, '', 'Colbert', 0),
(149, 'modificar', 'aborto', '2016-05-14 11:33:10', 1, '', 'Colbert', 4),
(150, 'insertar', 'analisis', '2016-05-14 11:33:30', 1, '', 'Colbert', 0),
(151, 'inciar sesion', 'login', '2016-05-14 14:27:47', 1, '', 'Colbert', 1),
(152, 'inciar sesion', 'login', '2016-05-23 09:44:08', 1, '', 'Colbert', 1),
(153, 'insertar', 'sexo_cria', '2016-05-23 09:46:30', 1, '', 'Colbert', 1),
(154, 'insertar', 'sexo_cria', '2016-05-23 09:46:43', 1, '', 'Colbert', 2),
(155, 'modificar', 'sexo_cria', '2016-05-23 09:46:51', 1, '', 'Colbert', 1),
(156, 'insertar', 'servicio', '2016-05-23 09:48:10', 1, '', 'Colbert', 0),
(157, 'insertar', 'parto', '2016-05-23 09:49:00', 1, '', 'Colbert', 0),
(158, 'insertar', 'modulo', '2016-05-23 10:24:02', 1, '', 'Colbert', 66),
(159, 'insertar', 'modulo', '2016-05-23 10:24:26', 1, '', 'Colbert', 67),
(160, 'modificar', 'permiso', '2016-05-23 10:24:40', 1, '', 'Colbert', 1),
(161, 'insertar', 'servicio', '2016-05-23 11:41:42', 1, '', 'Colbert', 0),
(162, 'insertar', 'parto', '2016-05-23 11:42:13', 1, '', 'Colbert', 0),
(163, 'inciar sesion', 'login', '2016-05-23 14:52:09', 1, '', 'Colbert', 1);
...
CREATE TABLE IF NOT EXISTS `control` (
  ...
  `con_rp` int(11) NOT NULL,
  `con_fecha` date NOT NULL,
  `con_control_1` int(11) DEFAULT NULL,
  `con_control_2` int(11) DEFAULT NULL,
...
(1, 1, 1, 1, '2016-01-01', 1),
(2, 1, 2, 1, '2016-01-01', 1),
(3, 2, 1, 1, '2016-01-01', 1),
(4, 3, 1, 1, '2015-01-02', 1),
(5, 4, 1, 1, '2014-01-03', 1),
(6, 2, 2, 1, '2015-04-11', 1),
(7, 1, 8, 1, '2016-01-06', 1),
(8, 2, 8, 2, '2016-01-07', 1);
...
(1, 'Indicación Especial 1', 'inesp1', 1),
(2, 'Indicación Especial 2', 'inesp2', 1);
...
(66, 'Sexo Cria', 41, 'sexo_cria', 1),
(67, 'Controles', 44, 'controles', 1);
...
(1, '1', '2016-01-06 00:00:00', 1, 1, '1', 1, 1),
(2, '2', '2016-01-07 00:00:00', 2, 2, '2', 1, 2);
...
(1, 1, '2016-05-23 00:00:00', 1, 2, 1, 1),
(2, 2, '2016-05-23 00:00:00', 2, 3, 1, 2);
...
(1, 'aborto', 'Casa', '1.png', 1),
(2, 'analisis', 'mensaje', '2.png', 1),
(3, 'celo', 'Calendario', '3.png', 1),
(4, 'enfermedad', 'Libro', '4.png', 1),
(5, 'indicaciones_especiales', 'Mas', '5.png', 1),
(6, 'medicacion', 'pastilla', '6.png', 1),
(7, 'muerte', 'Muerte', '7.png', 1),
(8, 'parto', 'Parto', '8.png', 1),
(9, 'servicio', 'Servicio', '9.png', 1),
(10, 'tacto_rectal', 'Tacto Rectal', '10.png', 1),
(11, 'venta', 'Venta', '11.png', 1),
(12, 'secado', 'Secado', '12.png', 1),
(13, 'rechazo', 'Rechazo', '13.png', 1);
...
--
ALTER TABLE `auditoria`
MODIFY `aud_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=164;
--
...
--
ALTER TABLE `modulo`
MODIFY `mod_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=68;
--
