...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-05-2016 a las 01:06:02
...
CREATE TABLE `causa_no_inseminal` (
...
CREATE TABLE `diagnostico_utero` (
...
CREATE TABLE `enfermedad_ovario` (
...
CREATE TABLE `especificacion_muerte` (
...
CREATE TABLE `especificacion_venta` (
...
CREATE TABLE `indicaciones_especiale` (
...
CREATE TABLE `indicaciones_especiales` (
...
CREATE TABLE `medi_cuartos_mamarios` (
...
--
ALTER TABLE `tipo_usuario`
  MODIFY `tipusu_id` int(11) NOT NULL AUTO_INCREMENT;
--
