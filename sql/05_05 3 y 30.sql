...
CREATE TABLE IF NOT EXISTS `causa_no_inseminal` (
  `cni_id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `indicaciones_especiale` (
  `indes_id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `indicaciones_especiales` (
  `indesp_id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `log_transacciones` (
  `logtr_id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `muerte` (
  `mue_id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `permiso` (
  ...
  PRIMARY KEY (`per_tipo_usuario`,`per_modulo`),
  KEY `per_tipo_user` (`per_tipo_usuario`),
  KEY `per_modulo` (`per_modulo`)
...
CREATE TABLE IF NOT EXISTS `personal` (
  ...
  `per_distrito` varchar(150) NOT NULL,
  PRIMARY KEY (`per_id`)
...
(5, '', 'Sergio', 'Santos', 'Martinez', '', '', 1, 1, 'morales'),
(6, '', 'Diego', 'Contreras', 'Ishuiza', '', '', 1, 0, '0'),
(7, '12345678', 'luz', 'irigoin', 'idrogo', 'morales', '999999999', 0, 0, 'san marti');
...
CREATE TABLE IF NOT EXISTS `raza` (
  `raz_id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `rechazo` (
  `recha_id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `sexo_cria` (
  `sexcr_id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `tacto_rectal` (
  `tarec_id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `tipo_registro` (
  `tipre_id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `usuario` (
  ...
  KEY `usu_personal` (`usu_personal`),
  KEY `usu_tipo_usuario` (`usu_tipo_usuario`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=4 ;
